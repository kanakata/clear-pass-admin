            ...
            <tbody>
                <?php if (!empty($pageData)): ?>
                    <?php foreach ($pageData as $info): ?>
                        <tr>
                            <td><?= e($info['username']) ?? "N\A" ?></td>
                            <td><?= e($info['admission number']) ?? "N\A" ?></td>
                            <td><?= e($info[$_GET['department'] . " debt"] ?? 'N/A'); ?></td>
                            <td><?= e($info[$_GET['department'] . " value"] ?? 'N/A'); ?></td>
                            <td
                                ...
                                ?>"><?= e($info[$_GET['department'] . " status"] ?? 'N/A'); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
