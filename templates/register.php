...
<h2 class="welcome">Hii👋there welcome to chebisaas school admin sign up page. Sign up for an account bellow ⬇️.</h2>
    ...
    <div class="ui_interface">
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            <label for="sirname">
                ...
                <input type="text" placeholder="email" name="sirname">
            </label>
            <label for="admission">
                <img src="./assets/icons/admission.png" alt="admission">
                <input type="text" placeholder="OTP" name="admission">
            </label>
            <!-- <label for="profile">
            ...
            <label for="index">
                ...
                <input type="text" placeholder="security number" name="index">
            </label>
            <label for="password">
